...
const SEARCH_COOKIES_HEADER = (currency = 'USD', region = 'US', language = 'en_US') => `aep_usuc_f=site=${LOCALE_SITE[language]}&c_tp=${currency}&region=${region}&b_locale=${language}&ae_u_p_s=0;`;
